...
--
-- Name: auditactionenum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.auditactionenum OWNER TO postgres;
...
--
-- Name: backgroundcheckstatusenum; Type: TYPE; Schema: public; Owner: postgres
--

CREATE TYPE public.backgroundcheckstatusenum AS ENUM (
    'pending',
    'approved',
    'rejected'
);
...
ALTER TYPE public.backgroundcheckstatusenum OWNER TO postgres;
...
--
-- Name: cancellationsourceenum; Type: TYPE; Schema: public; Owner: postgres
--

CREATE TYPE public.cancellationsourceenum AS ENUM (
    'passenger',
    'driver',
    'system'
);
...
ALTER TYPE public.cancellationsourceenum OWNER TO postgres;
...
--
-- Name: communicationstatusenum; Type: TYPE; Schema: public; Owner: postgres
--

CREATE TYPE public.communicationstatusenum AS ENUM (
    'pending',
    'sent',
    'delivered',
    'failed',
...
ALTER TYPE public.communicationstatusenum OWNER TO postgres;

--
-- Name: communicationtypeenum; Type: TYPE; Schema: public; Owner: postgres
--

CREATE TYPE public.communicationtypeenum AS ENUM (
    'sms',
    'email',
    'push_notification',
    'phone_call'
...
ALTER TYPE public.communicationtypeenum OWNER TO postgres;
...
--
-- Name: datatypeenum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.datatypeenum OWNER TO postgres;
...
--
-- Name: deliverymethodenum; Type: TYPE; Schema: public; Owner: postgres
--

CREATE TYPE public.deliverymethodenum AS ENUM (
    'push',
    'sms',
    'email',
    'in_app'
...
ALTER TYPE public.deliverymethodenum OWNER TO postgres;

--
-- Name: deliverystatusenum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.deliverystatusenum OWNER TO postgres;
...
--
-- Name: documenttypeenum; Type: TYPE; Schema: public; Owner: postgres
--

CREATE TYPE public.documenttypeenum AS ENUM (
    'license',
    'insurance',
    'vehicle_registration',
    'background_check'
...
ALTER TYPE public.documenttypeenum OWNER TO postgres;
...
--
-- Name: driverstatusenum; Type: TYPE; Schema: public; Owner: postgres
--

CREATE TYPE public.driverstatusenum AS ENUM (
    'offline',
    'online',
    'busy'
);
...
ALTER TYPE public.driverstatusenum OWNER TO postgres;
...
--
-- Name: locationtypeenum; Type: TYPE; Schema: public; Owner: postgres
--

CREATE TYPE public.locationtypeenum AS ENUM (
    'district',
    'sector',
    'landmark',
    'business',
...
ALTER TYPE public.locationtypeenum OWNER TO postgres;
...
--
-- Name: methodtypeenum; Type: TYPE; Schema: public; Owner: postgres
--

CREATE TYPE public.methodtypeenum AS ENUM (
    'mobile_money',
    'bank_card',
    'cash'
);
...
ALTER TYPE public.methodtypeenum OWNER TO postgres;
...
--
-- Name: notificationtypeenum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.notificationtypeenum OWNER TO postgres;
...
--
-- Name: paymenttypeenum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.paymenttypeenum OWNER TO postgres;
...
--
-- Name: payoutstatusenum; Type: TYPE; Schema: public; Owner: postgres
--

CREATE TYPE public.payoutstatusenum AS ENUM (
    'pending',
    'paid',
    'hold'
);
...
ALTER TYPE public.payoutstatusenum OWNER TO postgres;
...
--
-- Name: providerenum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.providerenum OWNER TO postgres;

--
-- Name: providerserviceenum; Type: TYPE; Schema: public; Owner: postgres
--

CREATE TYPE public.providerserviceenum AS ENUM (
    'twilio',
    'sendgrid',
    'firebase',
    'local'
...
ALTER TYPE public.providerserviceenum OWNER TO postgres;
...
--
-- Name: reviewtypeenum; Type: TYPE; Schema: public; Owner: postgres
--

CREATE TYPE public.reviewtypeenum AS ENUM (
    'passenger_to_driver',
    'driver_to_passenger'
);


ALTER TYPE public.reviewtypeenum OWNER TO postgres;
...
--
-- Name: ridestatusenum; Type: TYPE; Schema: public; Owner: postgres
--

CREATE TYPE public.ridestatusenum AS ENUM (
    'requested',
    'driver_assigned',
    'driver_arrived',
    'in_progress',
...
ALTER TYPE public.ridestatusenum OWNER TO postgres;
...
--
-- Name: usertypeenum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.usertypeenum OWNER TO postgres;
...
--
-- Name: verificationstatusenum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.verificationstatusenum OWNER TO postgres;
...
--
-- Name: votetypeenum; Type: TYPE; Schema: public; Owner: postgres
--

CREATE TYPE public.votetypeenum AS ENUM (
    'helpful',
    'not_helpful',
    'inappropriate'
);
...
ALTER TYPE public.votetypeenum OWNER TO postgres;
...
CREATE TABLE public.communication_logs (
    ...
    user_id uuid,
    ride_id uuid,
    communication_type public.communicationtypeenum NOT NULL,
    recipient character varying(255) NOT NULL,
    content text,
    provider public.providerserviceenum NOT NULL,
    external_id character varying(255),
    status public.communicationstatusenum,
...
CREATE TABLE public.driver_documents (
    id uuid NOT NULL,
    driver_id uuid,
    document_type public.documenttypeenum,
    document_url character varying(500) NOT NULL,
    verification_status public.verificationstatusenum,
    verified_by uuid,
...
CREATE TABLE public.driver_earnings (
    ...
    payout_status public.payoutstatusenum,
    payout_date date,
    created_at timestamp without time zone DEFAULT now()
);
...
CREATE TABLE public.drivers (
    ...
    vehicle_type public.vehicletypeenum NOT NULL,
    ...
    background_check_status public.backgroundcheckstatusenum,
    approval_status public.approvalstatusenum,
    rating numeric(3,2),
    total_rides integer,
    total_earnings numeric(12,2),
    current_status public.driverstatusenum,
...
CREATE TABLE public.locations (
    ...
    location_type public.locationtypeenum NOT NULL,
...
CREATE TABLE public.notifications (
    ...
    is_read boolean,
    delivery_method public.deliverymethodenum NOT NULL,
    delivery_status public.deliverystatusenum,
...
CREATE TABLE public.payment_methods (
    id uuid NOT NULL,
    user_id uuid,
    method_type public.methodtypeenum NOT NULL,
...
CREATE TABLE public.payments (
    ...
    payment_type public.paymenttypeenum,
    status public.paymentstatusenum,
...
CREATE TABLE public.review_votes (
    ...
    review_id uuid,
    user_id uuid NOT NULL,
    vote_type public.votetypeenum NOT NULL,
    created_at timestamp without time zone DEFAULT now()
);
...
CREATE TABLE public.reviews (
    ...
    review_text text,
    review_type public.reviewtypeenum NOT NULL,
    is_anonymous boolean,
    helpful_count integer,
    inappropriate_reports integer,
    is_hidden boolean,
    created_at timestamp without time zone DEFAULT now(),
    updated_at timestamp without time zone DEFAULT now(),
...
CREATE TABLE public.rides (
    ...
    driver_id uuid,
    ride_type public.vehicletypeenum NOT NULL,
    ...
    cancelled_by public.cancellationsourceenum,
    passenger_notes text,
    driver_notes text,
    payment_method public.paymentmethodenum,
    payment_status public.paymentstatusenum,
    created_at timestamp without time zone DEFAULT now(),
    updated_at timestamp without time zone DEFAULT now()
);
...
CREATE TABLE public.user_profiles (
    ...
    notification_preferences json DEFAULT '{"sms": true, "push": true, "email": true}'::jsonb,
    privacy_settings json DEFAULT '{"location_sharing": true, "ride_history_visible": false}'::jsonb,
    payment_method_id uuid,
    created_at timestamp without time zone DEFAULT now(),
    updated_at timestamp without time zone DEFAULT now()
);
...
--
-- Name: ride_tracking ride_tracking_driver_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ride_tracking
    ADD CONSTRAINT ride_tracking_driver_id_fkey FOREIGN KEY (driver_id) REFERENCES public.drivers(id);
...
--
-- Name: user_profiles user_profiles_payment_method_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_profiles
    ADD CONSTRAINT user_profiles_payment_method_id_fkey FOREIGN KEY (payment_method_id) REFERENCES public.payment_methods(id);
